...
export default function Page() {
    const { data, error, isLoading } = useSWR('/tours/?status=moderation', fetcherSWR)
    ...
    return (
        <>
            <div className="px-4 sm:px-6 lg:px-8 font-custom">
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        <h1 className="text-base font-semibold leading-6 text-gray-900">На модерации</h1>
                    </div>
                    <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <Button
                            ...
                            asChild={true}
                        >
                            <Link href="/admin/tour/create">Добавить экскурсию</Link>
                        </Button>
                    </div>
                </div>
                                                ...
                                                >
                                                    ...
                                                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                                        <Button onClick={async () => {
                                                            await fetcher(`/tours/${person.id}/`, 'PATCH', {
                                                                status: "approved",
                                                            },)
                                                        }}>
                                                            Модерация
            ...
            <div className="px-4 sm:px-6 lg:px-8 font-custom mt-24">
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
